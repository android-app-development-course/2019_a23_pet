...
import com.example.gohome.Organizer.Adapter.OrganizationProcessingFoldingCellAdapter;
...
public class OrganizerOrganizationProcessingFragment extends Fragment {
    ...
    private OrganizationProcessingFoldingCellAdapter organizationProcessingFoldingCellAdapter;
    private List<JoinAppliment> joinApplimentList;

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState ){
        View view = inflater.inflate(R.layout.fragment_organizer_organization_processing, null);
        ButterKnife.bind(this, view);

        xrv_organizerCheckDoing = view.findViewById(R.id.processing_xrecyclerview);
    ...
    private void init(){
        ...
        //适配器
        organizationProcessingFoldingCellAdapter = new OrganizationProcessingFoldingCellAdapter(this.getContext(), joinApplimentList);
        organizationProcessingFoldingCellAdapter.setClickCallBack(new OrganizationProcessingFoldingCellAdapter.ItemClickCallBack() {
            @Override
        ...
        xrv_organizerCheckDoing.setAdapter(organizationProcessingFoldingCellAdapter);
...
//                        }
                        //加载完成
                        organizationProcessingFoldingCellAdapter.notifyDataSetChanged(); //更新列表
