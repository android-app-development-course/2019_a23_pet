...
public class WindowUtil {
	...
	/*public static void main(String[] args) {
		LoggerUtil.info(getCpuRatioForWindows());
		LoggerUtil.info(getMemery());
		LoggerUtil.info(getDisk());
	}*/

	// 获取内存使用率
	public static String getMemery() {
		OperatingSystemMXBean osmxb = (OperatingSystemMXBean) java.lang.management.ManagementFactory
