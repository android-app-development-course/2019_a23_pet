...
//                            }
    ...
    private void initAdoptAppliment() {
        ...
        adoptApplimentList.add(new AdoptAppliment("黄小姐", "13124545434", "广州番禺区", "家里的猫猫一只猫在家无聊，养多一只陪她，领养代替购买", "兔叽", "1岁半", "猫猫", false, false, true, R.drawable.member_cat2, "2019.11.27 7:29", "职员", 2, 0, ""));
