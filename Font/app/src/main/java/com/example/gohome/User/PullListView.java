...
public class PullListView extends ListView {
    ...
    /**
     * 标志初始位置已经记录，一次滑动中记录一次。
     * 为了更好的处理滑动，根据需要，不在ACTION_DOWN记录初始位置
     * 而是在ACTION_MOVE中第一次符合条件的触发中记录初始位置
     */
     ...
     * 默认为滑动到底部自动加载更多
     */
    private int getMoreType = GET_MORE_TYPE_CLICK;
    ...
    private void init(Context context, AttributeSet attrs) {
         ...
         * 头部
         */
        headView = (LinearLayout) inflater.inflate(R.layout.pull_listview_head, null);
        ivHeadArrow = headView.findViewById(R.id.iv_head_arrow);
        pbHeadRefreshing = headView.findViewById(R.id.pb_head_refreshing);
        tvHeadTitle = headView.findViewById(R.id.tv_head_title);
         ...
         * 底部
         */
        footView = inflater.inflate(R.layout.pull_listview_foot, this, false);
        tvFootTitle = footView.findViewById(R.id.tv_foot_title);
        pbFootRefreshing = footView.findViewById(R.id.pb_foot_refreshing);
...
//        }
    ...
    /**
     * 如果项目中其他地方需要重新设置PullListView的OnScrollListener
