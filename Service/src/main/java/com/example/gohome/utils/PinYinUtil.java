...
public class PinYinUtil {
	...
	private static Logger LoggerUtil = LoggerFactory.getLogger("PinYinUtil");
	...
	private static PinYinUtil chineseSpelling = null;
	public static PinYinUtil getInstance() {
		if(chineseSpelling==null)
			chineseSpelling = new PinYinUtil();
		...
		try {
			...
			System.out
					.println("ERROR:ChineseSpelling.class-getChsAscii(String chs)"
							+ e);
			// log.error(ConstantUtil.API_CONTR + e);
		}
		return asc;
	}
	...
	/*public static void main(String[] args) {
		String str = "广东ss333sd2@#$#$990||";
		System.out.println(PinYinUtil.trans2PinYin(str));
	}*/
}
